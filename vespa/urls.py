...
urlpatterns = [
    ...
    path(
        "exoplanets/",
        TemplateView.as_view(template_name="waspstatic/exoplanets.html"),
        name="exoplanets",
    ),
    path(
        "accessibility-statement/",
        TemplateView.as_view(template_name="waspstatic/accessibility-statement.html"),
        name="accessibility",
    ),
    path(
        "privacy-policy/",
        TemplateView.as_view(template_name="waspstatic/privacy-policy.html"),
        name="privacy",
    ),
    path(
        "black-hole-hunters/",
        TemplateView.as_view(template_name="waspstatic/black-hole-hunters.html"),
        name="black-hole-hunters",
    ),
    path(
        "britishscienceweek/",
        TemplateView.as_view(template_name="waspstatic/bsw2022.html"),
    ...
    path(
        "vespa/export/",
        starcatalogue.views.GenerateExportView.as_view(),
    ...
    path(
        "vespa/source/<str:swasp_id>/",
        starcatalogue.views.SourceView.as_view(),
        name="view_source",
    ),
    path(
        "blog/",
    ...
    path(
        "blog/<int:year>/<str:month>/<int:day>/",
    ...
    path(
        "blog/<int:year>/<str:month>/<int:day>/<str:slug>/",
    ...
    path(
        "blog/<str:category>/",
        blog.views.CategoryListView.as_view(
            paginate_by=10,
            extra_context=blog_context,
        ),
        name="blog",
